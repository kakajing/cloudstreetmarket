package edu.zipcloud.cloudstreetmarket.core.services.impl;
...
public class DummyMarketServiceImpl implements IMarketService {
    ...
    @Override
    public DailyMartketActivityDTO getLastDayMarketActivity(String string) {
        ...
        return new DailyMartketActivityDTO("DAX 30", "GDAXI", map, Date.from(ldt.toInstant(ZoneOffset.UTC)));
    }
